...
- [ ] Registr dostupných motivů (cards_NN + dashboard_NN), aby obrazovka výběru nabízela motivy bez natvrdo zadaného seznamu a šlo přidat další motiv jen nahráním složky.
