# Phase 2 — Engine: datový model

**Goal:** Definovat typy Card/Suit/Rank, vytvořit 32 mariášových karet, zamíchání, rozdání ruky hráči i AI a počáteční odhazovací kartu — jako čisté funkce pokryté testy.

## Steps
- [done] Typy Card/Suit/Rank a konstanty
- [done] Tvorba balíčku 32 karet
- [done] Zamíchání s injektovaným RNG
- [done] Rozdání a počáteční stav hry
- [done] Unit testy datového modelu
