# Phase 5 — AI soupeř: heuristika tahu

**Goal:** Čistá funkce, která pro daný stav vrátí vždy jen platný tah AI (zahrání karty / výběr barvy po svršku / líznutí), s jednoduchou heuristikou reagující na nakupené sedmy a vynucenou barvu — pokrytá unit testy.

## Steps
- [done] Typ tahu AI a kostra ai.ts
- [done] Heuristika výběru karty (priorita)
- [done] Výběr barvy po svrškovi
- [done] chooseAiMove: sestavení tahu + invariant platnosti
- [done] Unit testy AI
