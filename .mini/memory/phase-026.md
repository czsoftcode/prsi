# Phase 26 — Engine: guard pořadí a vítěze

**Goal:** playCard, drawCard a standAce odmítnou (Error) tah nesprávného hráče i tah po skončené hře, čímž se kontrakt pravidel přesune z UI do enginu; pokryto negativními testy v moves.test.ts.

## Steps
- [done] Sdílený guard tahu (assertTurn)
- [done] Zapojit guard do playCard, drawCard, standAce
- [done] Negativní testy: tah nesprávného hráče
- [done] Negativní testy: tah po skončené hře
- [done] Zelená regrese: suite, build, lint, E2E
