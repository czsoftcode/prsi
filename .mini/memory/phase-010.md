# Phase 10 — README s návodem a snímkem

**Goal:** Přepsat README.md: popis hry, návod na instalaci a spuštění přes Vite (npm install/dev/build) a vložený snímek herní plochy z public/images/hraci_plocha.png.

## Steps
- [done] Struktura README: nadpis + popis hry
- [done] Sekce Pravidla (stručně)
- [done] Sekce Instalace a spuštění
- [done] Vložení snímku herní plochy
- [done] Vizuální ověření renderu README
